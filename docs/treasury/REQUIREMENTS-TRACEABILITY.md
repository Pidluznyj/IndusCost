...
| R17 | Alertas | Y | alert rules + settings | `GET …/alerts`, `GET/PUT …/alert-settings` | dashboard/agenda | `treasuryAlertRules.test.ts`, gaps wiring | DONE | feed + settings; P68 audit UPDATE `ALERT_SETTINGS` | sem push externo (fora de escopo atual) |
