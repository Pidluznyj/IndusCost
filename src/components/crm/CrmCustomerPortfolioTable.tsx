...
/**
 * Tabela operacional da Carteira de Clientes (Fase 11/12 da revisão do
 * CRM). Substitui a lista estreita de cards: densidade e colunas de
 * verdade — ferramenta de trabalho, não cartão de visita.
 */
export const CrmCustomerPortfolioTable: React.FC<CrmCustomerPortfolioTableProps> = ({
  ...
  return (
    <div className="rounded-2xl border border-border bg-card shadow-sm overflow-hidden">
      ...
      {listHasMore ? (
        <p className="px-4 py-2.5 text-[11px] text-muted-foreground border-t border-border/60 text-center">
