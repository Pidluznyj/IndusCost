...
/**
 * Comparação entre responsáveis (Fase 10 da revisão do CRM). Visível só
 * quando "Todos os responsáveis" está selecionado — comparar uma pessoa
 * contra ela mesma não ajuda ninguém. Mostra participação (% do total),
 * não só valor absoluto, para dar contexto de tamanho de carteira sem
 * inventar uma métrica nova: os números vêm do mesmo motor oficial
 * (`loadCrmSalesOrderMetrics`) usado pela Gestão Geral.
 */
