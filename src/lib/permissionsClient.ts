...
export const FRONTEND_PERMISSION_RESOURCES: readonly FrontendPermissionResource[] = [
  ...
  },
  {
    ...
    type: "SUBMENU",
    parentKey: ResourceKeys.ENGENHARIA,
    legacyAliasKeys: ["products.view", "simulations.view", "costs.view"],
  },
  {
    ...
    type: "SUBMENU",
    parentKey: ResourceKeys.ENGENHARIA,
    legacyAliasKeys: ["simulations.view", "costs.view"],
  },
  {
  ...
  },
  {
    ...
    type: "TAB",
    parentKey: ResourceKeys.ADMIN_PESSOAS,
    legacyAliasKeys: ["employees.sensitive_data.view", "employees.edit"],
  },
  {
  ...
  },
  {
    ...
    type: "TAB",
    parentKey: ResourceKeys.ADMIN_PESSOAS,
    legacyAliasKeys: ["employees.epi.manage", "employees.edit"],
  },
  {
