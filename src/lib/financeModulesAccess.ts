...
export const FINANCE_MODULE_RESOURCE_KEYS = {
  ...
  treasuryDashboard: "finance.treasury.dashboard",
  treasuryAgenda: "finance.treasury.agenda",
  treasuryReceivables: "finance.treasury.receivables",
  treasuryReceivablesPromise: "finance.treasury.receivables.promise",
  treasuryReceivablesCollection: "finance.treasury.receivables.collection",
  treasuryPayables: "finance.treasury.payables",
  treasuryPayablesProgram: "finance.treasury.payables.program",
  treasuryAccounts: "finance.treasury.accounts",
  treasuryBalances: "finance.treasury.balances",
  treasuryTransfers: "finance.treasury.transfers",
  treasuryManualEntries: "finance.treasury.manual_entries",
  treasuryReconciliation: "finance.treasury.reconciliation",
  treasuryReconciliationReverse: "finance.treasury.reconciliation.reverse",
  treasuryExceptions: "finance.treasury.exceptions",
  treasuryClosing: "finance.treasury.closing",
  treasuryAudit: "finance.treasury.audit",
  treasuryReports: "finance.treasury.reports",
...
export const FINANCE_LETICIA_DENIED_RESOURCE_KEYS = [
  ...
  FINANCE_MODULE_RESOURCE_KEYS.treasury,
  FINANCE_MODULE_RESOURCE_KEYS.treasuryDashboard,
  FINANCE_MODULE_RESOURCE_KEYS.treasuryAgenda,
  FINANCE_MODULE_RESOURCE_KEYS.treasuryReceivables,
  FINANCE_MODULE_RESOURCE_KEYS.treasuryReceivablesPromise,
  FINANCE_MODULE_RESOURCE_KEYS.treasuryReceivablesCollection,
  FINANCE_MODULE_RESOURCE_KEYS.treasuryPayables,
  FINANCE_MODULE_RESOURCE_KEYS.treasuryPayablesProgram,
  FINANCE_MODULE_RESOURCE_KEYS.treasuryAccounts,
  FINANCE_MODULE_RESOURCE_KEYS.treasuryBalances,
  FINANCE_MODULE_RESOURCE_KEYS.treasuryTransfers,
  FINANCE_MODULE_RESOURCE_KEYS.treasuryManualEntries,
  FINANCE_MODULE_RESOURCE_KEYS.treasuryReconciliation,
  FINANCE_MODULE_RESOURCE_KEYS.treasuryReconciliationReverse,
  FINANCE_MODULE_RESOURCE_KEYS.treasuryExceptions,
  FINANCE_MODULE_RESOURCE_KEYS.treasuryClosing,
  FINANCE_MODULE_RESOURCE_KEYS.treasuryAudit,
  FINANCE_MODULE_RESOURCE_KEYS.treasuryReports,
