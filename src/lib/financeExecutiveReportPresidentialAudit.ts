...
export const PRESIDENTIAL_EXECUTIVE_REPORT_AUDIT_MATRIX: PresidentialAuditRow[] = [
  ...
  },
  {
    ...
    componentOrBuilder: "salesOrderRulesEngine",
    currentSource: "Todos os pedidos elegíveis do ano",
    officialMotor: "Regra de mercado (isGroupCompanyCustomer)",
    status: "PRECISA_VALIDACAO",
    notes:
      "Faturamento NF-e exclui grupo; motor de pedidos ainda não aplica isGroupCompanyCustomer — alinhar com Comercial se política exigir.",
  },
  {
    section: "Pedidos de Venda",
    indicator: "Filtro empresa (Lazarios/Koppetel/SM)",
    componentOrBuilder: "buildFinanceExecutiveReport",
    currentSource: "yearCtx apenas — ignora filters.company",
    officialMotor: "financeSalesOrdersDashboard (companyIssuer)",
    status: "PRECISA_VALIDACAO",
    notes: "Tela oficial de Pedidos suporta company; relatório ainda consolida todas as filiais.",
  },
  {
    section: "Faturamento",
