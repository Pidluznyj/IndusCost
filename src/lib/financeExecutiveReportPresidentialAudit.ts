...
export const PRESIDENTIAL_EXECUTIVE_REPORT_AUDIT_MATRIX: PresidentialAuditRow[] = [
  ...
  },
  {
    ...
    currentSource: "SalesOrder (Nomus sync) via buildSalesOrderListWhere",
    officialMotor: "salesOrdersListSummary + salesOrderRulesAdapter",
    status: "OK_USA_MOTOR_OFICIAL",
    notes:
      "População = Comercial → Pedidos de venda (exclui CANCELLED + MISSING_CONFIRMED). Mês = highlightMonth do relatório.",
  },
  {
    section: "Pedidos de Venda",
