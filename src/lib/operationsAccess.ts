...
export const OPERATIONS_PILOT_ENDPOINTS = [
  ...
  {
    method: "GET",
    path: "/api/purchase-quotations/:id/awards",
    resourceKey: "operations.purchases",
    action: "view",
  },
  {
  ...
  {
    method: "POST",
    path: "/api/purchase-quotations/:id/awards/:awardId/approve",
    resourceKey: "operations.purchases",
    action: "approve",
  },
  {
    method: "POST",
    path: "/api/purchase-quotations/:id/awards/:awardId/reject",
    resourceKey: "operations.purchases",
    action: "approve",
  },
  {
  ...
  {
    method: "GET",
    path: "/api/purchase-orders/:id/history",
    resourceKey: "operations.purchases",
    action: "view",
  },
  {
    method: "GET",
    path: "/api/purchase-orders/:id/pdf",
    resourceKey: "operations.purchases",
    action: "view",
  },
  {
    method: "POST",
    path: "/api/purchase-orders/from-award/:awardId",
    resourceKey: "operations.purchases",
    action: "update",
  },
  {
