...
export const COMMERCIAL_RESOURCE_KEYS = {
  ...
  crmReports: "commercial.crm.reports",
...
export const COMMERCIAL_PILOT_ENDPOINTS = [
  ...
  { method: "POST", path: "/api/crm/reports/operational/export", resourceKey: "commercial.crm.reports", action: "view" },
  { method: "POST", path: "/api/crm/reports/custom", resourceKey: "commercial.crm.reports", action: "view" },
  { method: "POST", path: "/api/crm/reports/custom/export", resourceKey: "commercial.crm.reports", action: "view" },
  ...
  { method: "GET", path: "/api/commercial/sales-order-flow/feature-status", resourceKey: "commercial.sales_orders.flow", action: "view" },
  ...
  { method: "POST", path: "/api/commissions/receipt-closing/cancel", resourceKey: "commercial.commissions.reprocess", action: "reprocess" },
  { method: "POST", path: "/api/commissions/receipt-closing/reprocess-preview", resourceKey: "commercial.commissions.reprocess", action: "reprocess" },
  { method: "POST", path: "/api/commissions/receipt-closing/reprocess-apply", resourceKey: "commercial.commissions.reprocess", action: "reprocess" },
