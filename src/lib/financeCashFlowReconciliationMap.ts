...
export const FINANCE_CASH_FLOW_RECONCILIATION_MAP: readonly FinanceCashFlowReconciliationEntry[] =
  [
    // ─── Visão Geral — Resumo executivo ───
    {
      ...
      sourceFunction: "resolveCanonicalArYearMetrics → resolveOfficialArCashFlowExecutiveMetrics.receivedYtd",
      rowScope: "ytd_period",
      ...
      arEquivalent: "AR motor oficial receivedYtd (settlementDate)",
      cashFlowInternalOracle: "filterArRowsForYtdReceived",
      conceptualException:
        "SEMANTICALLY_DIFFERENT do card YTD por vencimento (sumArReceivedInPeriod / dueDate).",
      alternatePath: "executiveYtd.received.currentAmount (dueDate — conceito distinto)",
    },
    {
      ...
      sourceModule: "financeCashFlowExecutiveSummary.ts",
      sourceFunction: "resolveCanonicalArYearMetrics → openUntilYearEnd",
      rowScope: "ytd_period",
      officialBase: "ar_management",
      usesArOfficial: true,
      usesApOfficial: false,
    ...
    },
    {
      ...
      sourceModule: "financeCashFlowExecutiveSummary.ts",
      sourceFunction: "resolveCanonicalArYearMetrics → estimatedYearTotal (receivedYtd + openUntilYearEnd)",
      rowScope: "ytd_period",
      officialBase: "ar_management",
      usesArOfficial: true,
      usesApOfficial: false,
    ...
    // ─── Linha do tempo mensal (oráculo validado) ───
    {
      ...
      sourceModule: "financeCashFlowExecutiveSummary.ts",
      sourceFunction: "buildExecutiveMonthlyTimeline dateAxis=dueDate",
      ...
      alternatePath: "executiveSummary.monthlyTimeline (eixo movement — conceito distinto)",
    },
    {
    ...
    },
    {
      ...
      label: "Recebido YTD por vencimento (com comparação)",
      sourceModule: "financeCashFlowExecutiveYtd.ts",
      sourceFunction: "buildYtdReceivedComparison → sumArReceivedInPeriod (dueDate)",
      rowScope: "ytd_period",
      officialBase: "ar_management",
      usesArOfficial: true,
      usesApOfficial: false,
      ...
      conceptualException:
        "SEMANTICALLY_DIFFERENT do Recebido YTD oficial (settlementDate) do resumo executivo.",
      alternatePath: "executiveSummary.receivable.receivedYtd",
    },
    {
      id: "ytd_trend_chart",
    ...
    },
    {
      ...
      apPurchaseOrderExcluded: "n/a",
      apOperationalDate: "n/a",
      respectsAppliedFilters: false,
      arEquivalent: "buildFinanceAccountsReceivableDashboard.customerRanking (open balance)",
      conceptualException:
        "Carteira aberta: ignora ano/mês da página. Top N — soma dos itens ≠ carteira inteira.",
    },
    {
      id: "top_suppliers",
      uiBlock: "PartyList",
