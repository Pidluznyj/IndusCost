...
export const FINANCE_CASH_FLOW_RECONCILIATION_MAP: readonly FinanceCashFlowReconciliationEntry[] =
  [
    ...
    },
    {
      ...
      label: "Pago YTD",
      sourceModule: "financeCashFlowExecutiveSummary.ts",
      sourceFunction: "financeAccountsPayableRulesEngine → cashPaidYtd (AP_CASH_REALIZED: só amountPaid informado, data efetiva canônica)",
      rowScope: "ytd_period",
      ...
      respectsAppliedFilters: true,
      apEquivalent: "Contas a Pagar › Pago (paidYtd, AP_SETTLED) — o Fluxo usa cashPaidYtd (AP_CASH_REALIZED); diferem pelas baixas sem evidência de caixa",
      conceptualException: "Pago YTD do Fluxo = caixa realizado (amountPaid informado) por data efetiva; baixa sem numerário/forçada/sem valor pago fica fora. Eixo por pagamento — não precisa bater com a soma mensal por dueDate.",
    ...
    },
    {
      ...
      sourceModule: "financeAccountsPayableRulesEngine.ts",
      sourceFunction: "buildAccountsPayableMetrics → openUntilYearEnd (data-base inclusive → 31/12; sem vencidos)",
      rowScope: "ytd_period",
      officialBase: "ap_management",
      usesArOfficial: false,
      usesApOfficial: true,
    ...
    {
      id: "exec_ap_overdue_open",
      uiBlock: "FinanceCashFlowExecutiveSummaryPanel",
      uiTab: "overview",
      payloadPath: "executiveSummary.payable.overdueOpenBeforeBase",
      label: "Vencido em aberto",
      sourceModule: "financeAccountsPayableRulesEngine.ts",
      sourceFunction: "buildAccountsPayableMetrics → overdueOpenBeforeBase (aberto, vencimento operacional < data-base, dentro do ano; alocado na dueDate original)",
      rowScope: "ytd_period",
      officialBase: "ap_management",
      usesArOfficial: false,
      usesApOfficial: true,
      ...
      apOperationalDate: true,
      respectsAppliedFilters: true,
      apEquivalent: "AP vencido gerencial no ano (mesma população; sem filtro de mês)",
    },
    {
      id: "exec_ap_open_remaining_obligation",
      uiBlock: "FinanceCashFlowExecutiveSummaryPanel",
      uiTab: "overview",
      payloadPath: "executiveSummary.payable.openRemainingObligation",
      label: "Total ainda a pagar",
      sourceModule: "financeAccountsPayableRulesEngine.ts",
      sourceFunction: "buildAccountsPayableMetrics → openRemainingObligation = overdueOpenBeforeBase + openUntilYearEnd",
      rowScope: "ytd_period",
      officialBase: "ap_management",
      usesArOfficial: false,
      usesApOfficial: true,
      ...
      apOperationalDate: true,
      respectsAppliedFilters: true,
      apEquivalent: "Contas a Pagar › Em aberto (cards.totalOpenAmount) no mesmo ano, sem filtro de mês",
    },
    {
