...
export const ACTION_PERMISSION_SURFACES: readonly ActionPermissionSurface[] = [
  ...
  },
  {
    ...
    writeEndpoints: [
      ...
      { method: "POST", path: "/api/purchase-orders/from-award/:awardId", action: "edit" },
      { method: "POST", path: "/api/purchase-orders/:id/approve", action: "approve" },
      { method: "POST", path: "/api/purchase-orders/:id/send", action: "edit" },
      { method: "POST", path: "/api/purchase-orders/:id/confirm", action: "edit" },
      { method: "POST", path: "/api/purchase-orders/:id/cancel", action: "edit" },
