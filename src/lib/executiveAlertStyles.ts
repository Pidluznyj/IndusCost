...
export const EXECUTIVE_ALERT_VARIANTS: Record<ExecutiveAlertVariant, VariantTokens> = {
  ...
  success: {
    shell: "border-[#86EFAC] bg-[#ECFDF5] dark:border-[#86EFAC] dark:bg-[#ECFDF5]",
    title: "text-[#065F46]",
    description: "text-[#065F46]",
    badge: "border-[#86EFAC] bg-[#D1FAE5] text-[#065F46]",
    iconWrap: "bg-[#D1FAE5] text-[#065F46]",
    panel: "border-[#86EFAC] bg-white dark:border-[#86EFAC] dark:bg-white",
    panelTitle: "text-[#065F46]",
  },
  info: {
