...
LOCK_FILE="/tmp/induscost-nomus-sales-orders.lock"
MODE="${1:-apply}"
...
export NOMUS_SALES_ORDERS_START_PAGE=1
export NOMUS_SALES_ORDERS_MAX_PAGES=1

echo "NOMUS_SYNC_LOG_DIR=$NOMUS_SYNC_LOG_DIR"
echo "NOMUS_SALES_ORDERS_START_PAGE=$NOMUS_SALES_ORDERS_START_PAGE"
